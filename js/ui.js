...
function toggleLoading(isLoading) {
  ...
  if(isLoading) {
    ...
    loadingIcon.setAttribute("class", "fas fa-hourglass-half");
    searchButton.innerHTML = "";
    searchButton.appendChild(loadingIcon);
    searchButton.appendChild(document.createTextNode(" Loading..."));
    searchButton.disabled = true;
  } else {
    const loadingIcon = document.createElement("i");
    loadingIcon.setAttribute("class", "fas fa-search");
    searchButton.innerHTML = "";
    searchButton.appendChild(loadingIcon);
